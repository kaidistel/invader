...
// Pegasus 16: the powered swing axle is mechanically fixed to the lifting boom.
// At zero swing angle the passenger arm therefore inherits the boom inclination
// instead of being corrected back to world-vertical.
export const RIDE_LIFT=1, MAX_LIFT=1, MAX_SIDE_ANGLE=86*Math.PI/180;
